...
We are grateful to the following individuals who have offered up their time and expertise to review packages submitted to rOpenSci.
    ...
    #> Warning in air_get(base = "appZIB8hgtvjoV99D", table = "Reviewers",
    #> combined_result = FALSE): partial argument match of 'table' to 'table_name'
    #> Warning in air_get(base = "appZIB8hgtvjoV99D", table = "Reviewers",
    #> combined_result = FALSE, : partial argument match of 'table' to
    #> 'table_name'
    #> Warning in `$.data.frame`(reviewers2, field): Partial match of 'field' to

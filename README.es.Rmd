...
# Revisión por pares de software de rOpenSci

<!-- README.es.md se genera a partir de README.es.Rmd. Por favor, edita ese archivo -->

Gracias por considerar enviar tu paquete para ser incluido en la suite de rOpenSci. 
Todos los paquetes contribuidos por la comunidad pasan por un proceso abierto de [revisión por pares](https://ropensci.org/blog/2017/09/01/nf-softwarereview/) para asegurar un nivel de calidad consistente. 
Este proceso también nos permite controlar que tu paquete cumple con nuestras directrices y es una oportunidad de intercambio si es necesario pedir excepciones. 
...
**Es obligatorio respetar nuestro código de conducta)[https://ropensci.org/codigo-de-conducta/] para todas las personas involucradas en nuestro proceso de revisión**

* [¿Por qué enviar un paquete a rOpenSci y cómo se hace?](#why-submit)
* [¿Por qué revisar paquetes para rOpenSci y cómo se hace?](#why-review)
* [Más recursos](#further)
* [Edición y revisión](#editors)

# <a href="#why-submit" name="why-submit"></a>¿Por qué enviar un paquete a rOpenSci y cómo se hace?
...
Si quieren enviar un paquete, lee nuestra [guía de autoría](https://devdevguide.netlify.app/es/softwarereview_author.es.html) antes de abrir un issue de envío en este repositorio.

## <a href="#why-review" name="why-review"></a>¿Por qué revisar paquetes para rOpenSci y cómo se hace?
...
Por favor también lee [nuestra guía de revisión](https://devdevguide.netlify.app/es/softwarereview_reviewer.es.html).
...
* capítulos dedicados a buenas prácticas en mantenimiento de paquetes

* varias plantillas: [plantilla de revisión](https://devdevguide.netlify.app/es/reviewtemplate.es.html), [plantilla para quien hace la edición](https://devdevguide.netlify.app/es/editortemplate.es.html), [plantilla para pedido de revisión](https://devdevguide.netlify.app/es/reviewrequesttemplate.es.html). 
...
# <a href="#editors" name="editors"></a> Edición y revisión

### Editores asociados

Organizan el proceso de Revisión por Pares de rOpenSci:
...
También agradecemos a las siguientes personas que tomaron el rol de edición de forma invitaa. 

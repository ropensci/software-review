...
We currently have `nrow(reviewers)` in the database, and `r sum(reviewers$last_review < as.POSIXct(Sys.Date() - lubridate::days(180)))` have
not done a review in at least six months.
